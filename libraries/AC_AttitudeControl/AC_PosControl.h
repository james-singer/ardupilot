...
public:
    ...
    */
    ...
    // get strain output 
    float get_strain_output() const { return _strain_out; }
...
protected:
    ...
    AC_PID          _pid_strain_z;      // Z axis strain controller
    ...
    // Ian
    float       _strain_out = 0.0f; // strain output from controller, used to calculate the throttle output
