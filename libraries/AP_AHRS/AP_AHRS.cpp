...
// (Ian)
///////////////////
bool AP_AHRS::set_oflow_vector( float p, float q, float u, float v , float active_cams)
{
    oflow_states.oflow_state[0] = p;
    oflow_states.oflow_state[0] = q;
    oflow_states.oflow_state[0] = u;
    oflow_states.oflow_state[0] = v;
