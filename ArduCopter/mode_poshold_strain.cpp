...
bool ModePosHoldStrain::init(bool ignore_checks)
{
...
void ModePosHoldStrain::update_pilot_lean_angle(float &lean_angle_filtered, float &lean_angle_raw)
{
...
float ModePosHoldStrain::mix_controls(float mix_ratio, float first_control, float second_control)
{
...
void ModePosHoldStrain::update_brake_angle_from_velocity(float &brake_angle, float velocity)
{
    float lean_angle;
...
void ModePosHoldStrain::init_wind_comp_estimate()
{
    wind_comp_ef.zero();
    wind_comp_timer = 0;
    wind_comp_roll = 0.0f;
...
void ModePosHoldStrain::update_wind_comp_estimate()
{
...
void ModePosHoldStrain::get_wind_comp_lean_angles(float &roll_angle, float &pitch_angle)
{
    // reduce rate to 10hz
    wind_comp_timer++;
...
void ModePosHoldStrain::roll_controller_to_pilot_override()
{
...
void ModePosHoldStrain::pitch_controller_to_pilot_override()
{
